...
namespace GdbControl.Tests
{
    ...
    public class GdbControlTests
    {
        ...
        public static readonly Filename DebuggedProgramFilename = new Filename("GdbControl.TestDebugee.exe");
        public static readonly SubdirPath GdbAbsolutePath = new SubdirPath(@"C:\MinGW\bin");
        ...
        public global::GdbControl.GdbControl CreateGdbControlAndConnectEvents(Dictionary<string, string> environment)
        {
            ...
            var workingDir = new SubdirPath(@"f:\PROJECT_MYNE\interfaces\Vault\Software\01_Development\DesFireEV2\");
            var gdbPath = new FilePath(new SubdirPath(@"f:\PROJECT_MYNE\interfaces\Vault\Software\04_Tools\GOP_HAL\12_Devenv\shared\gdb\"), new Filename(@"gdb.exe"));
