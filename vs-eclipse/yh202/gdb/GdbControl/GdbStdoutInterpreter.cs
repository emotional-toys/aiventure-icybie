...
namespace TestTools
{
    public class GdbStdoutInterpreter
    {
        ...
        private readonly global::TestTools.GdbControl GdbControlInstance;

        public GdbStdoutInterpreter(global::TestTools.GdbControl gdbControlInstance)
        {
        ...
        {
            var data = global::TestTools.GdbControl.InterpretBufferAsCString(GdbOutputDataBuffer);
            HandleCurrentGdbOutputData = DistributeGdbOutputDataByPrefix;
